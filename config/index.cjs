...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx81a6007b365548f6',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a5fd51a8136345f6ef57c70859f3bc84',
  ...
  USERS: [
    {
      ...
      id: 'ozFlF6uP9hRuC70cvgYVFrprJXDg',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '9RgnG2hGMUX5CjsnDAhScSuYYSCaUnAgaEW3AB9ai2A',
      // 所在省份
      province: '北京市',
      // 所在城市
      city: '海淀区',
      ...
      openUrl: 'https://www.bilibili.com/n',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '汪汪队队长', year: '2002', date: '04-10',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2020', date: '09-03',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '节日', name: '恋爱纪念日', year: '2002', date: '05-21',
        },
        {
          type: '节日', name: '结婚纪念日', year: '2021', date: '09-01',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-05-21' },
        // 结婚纪念日
        { keyword: 'marry_day', date: '2022-07-16' },
        // 退伍日
